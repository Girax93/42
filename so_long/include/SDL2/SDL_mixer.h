 ...
 */
typedef struct _Mix_Music t_mix_music;
 ...
 * \sa Mix_FreeMusic
 */
extern DECLSPEC t_mix_music * SDLCALL Mix_LoadMUS(const char *file);
 ...
 * \sa Mix_FreeMusic
 */
extern DECLSPEC t_mix_music * SDLCALL Mix_LoadMUS_RW(SDL_RWops *src, int freesrc);
 ...
 * \sa Mix_FreeMusic
 */
extern DECLSPEC t_mix_music * SDLCALL Mix_LoadMUSType_RW(SDL_RWops *src, Mix_MusicType type, int freesrc);
 ...
 */
extern DECLSPEC void SDLCALL Mix_FreeMusic(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.0.0
 */
extern DECLSPEC Mix_MusicType SDLCALL Mix_GetMusicType(const t_mix_music *music);
 ...
 */
extern DECLSPEC const char *SDLCALL Mix_GetMusicTitle(const t_mix_music *music);
 ...
 * \sa Mix_GetMusicCopyrightTag
 */
extern DECLSPEC const char *SDLCALL Mix_GetMusicTitleTag(const t_mix_music *music);
 ...
 * \sa Mix_GetMusicCopyrightTag
 */
extern DECLSPEC const char *SDLCALL Mix_GetMusicArtistTag(const t_mix_music *music);
 ...
 * \sa Mix_GetMusicCopyrightTag
 */
extern DECLSPEC const char *SDLCALL Mix_GetMusicAlbumTag(const t_mix_music *music);
 ...
 * \sa Mix_GetMusicAlbumTag
 */
extern DECLSPEC const char *SDLCALL Mix_GetMusicCopyrightTag(const t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.0.0.
 */
extern DECLSPEC int SDLCALL Mix_PlayMusic(t_mix_music *music, int loops);
 ...
 * \since This function is available since SDL_mixer 2.0.0.
 */
extern DECLSPEC int SDLCALL Mix_FadeInMusic(t_mix_music *music, int loops, int ms);
 ...
 * \since This function is available since SDL_mixer 2.0.0.
 */
extern DECLSPEC int SDLCALL Mix_FadeInMusicPos(t_mix_music *music, int loops, int ms, double position);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC int SDLCALL Mix_GetMusicVolume(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC double SDLCALL Mix_GetMusicPosition(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC double SDLCALL Mix_MusicDuration(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC double SDLCALL Mix_GetMusicLoopStartTime(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC double SDLCALL Mix_GetMusicLoopEndTime(t_mix_music *music);
 ...
 * \since This function is available since SDL_mixer 2.6.0.
 */
extern DECLSPEC double SDLCALL Mix_GetMusicLoopLengthTime(t_mix_music *music);
